...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Film MVC') ?></title>
    <style>
        ...
        .btn { display: inline-block; padding: .4rem .9rem; border-radius: 4px; text-decoration: none; border: none; cursor: pointer; font-size: 1rem; }
        .btn-primary   { background: #007bff; color: #fff; }
        .btn-secondary { background: #6c757d; color: #fff; }
        .btn-danger    { background: #dc3545; color: #fff; }
        input[type=text], input[type=number] { width: 100%; padding: .4rem; box-sizing: border-box; margin-bottom: .75rem; }
